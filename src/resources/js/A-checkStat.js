        ...
        .then((data) => {
          ...
          if (ut != 2) {
            ...
            function displayVals() {
              ...
              else if(singleValues == "Monthly" && singleValues2 =="Distribution Report"){
                distributionReportMonthly();
              }
              else if(singleValues == "Annually" && singleValues2 =="Distribution Report"){
                distributionReportAnnually();
              }
            }
            ...
            function distributionReportMonthly() {
              var yValues = [];
              var xValues = [];
              ...
              for (var j=0; j < 12; j++) {
                ...
                if(data["DistributionReportMonthDetails"][1][z]!=q)
                {
                ...
                if(data["DistributionReportMonthDetails"][1][z]==q)
                {
                  yValues[r] = data["DistributionReportMonthDetails"][0][z];
                  console.log(data["DistributionReportMonthDetails"]);
                   z++;
            ...
            function distributionReportAnnually() {
              var yValues = [];
              var xValues = [];
              ...
              for (var j=0; j < 5; j++) {
                ...
                if(data["DistributionReportYearDetails"][1][z]!=q)
                {
                ...
                if(data["DistributionReportYearDetails"][1][z]==q)
                {
                  yValues[r] = data["DistributionReportYearDetails"][0][z];
                  console.log(data["DistributionReportYearDetails"]);
                  z++;
