    ...
    if(token == undefined){
        ...
        if(ut!=5){
            ...
            setTimeout(function() {
                ...
                var aLicense = document.getElementById('aLicense');
                var rLicense = document.getElementById('rLicense');
                var nextLicense = document.getElementById('nextLicense');
                ...
                setTimeout(function() {
                    ...
                    aLicense.innerHTML = data['acceptedLicense'];
                    rLicense.innerHTML = data['rejectedLicense'];
                    nextLicense.innerHTML = data['nextEventDate'];
...
changeiinfo.addEventListener("click", ()=>{
    window.location = "SO-ChangeInfo.html";
});